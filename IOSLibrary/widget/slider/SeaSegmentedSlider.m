...
@interface SeaSegmentedSlider ()
{
    SeaSegmentedSliderItem *handler;
    CGPoint diffPoint;
    NSArray *titlesArr;
    float oneSlotSize;
}
...
@implementation SeaSegmentedSlider
...
-(id) initWithFrame:(CGRect) frame Titles:(NSArray *) titles
{
    if (self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, 70)])
    {
        ...
        handler = [SeaSegmentedSliderItem buttonWithType:UIButtonTypeCustom];
